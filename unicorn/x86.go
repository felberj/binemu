...
func (u *Unicorn) RegWriteMmr(reg int, value *X86Mmr) error {
...
func (u *Unicorn) RegReadMmr(reg int) (*X86Mmr, error) {
	var val C.uc_x86_mmr
...
func (u *Unicorn) RegWriteX86Msr(reg uint64, val uint64) error {
	msr := C.uc_x86_msr{
		rid:   C.uint32_t(reg),
...
func (u *Unicorn) RegReadX86Msr(reg uint64) (uint64, error) {
	msr := C.uc_x86_msr{
		rid: C.uint32_t(reg),
	}
